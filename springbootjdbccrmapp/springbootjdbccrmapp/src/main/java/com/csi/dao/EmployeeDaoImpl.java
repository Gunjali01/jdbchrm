...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    String SELECT_BY_NAME_SQL = "select * from employee where empname = ?";

    String UPDATE_SQL = "update employee set empname = ?, empaddress = ?, empcontactnumber = ?, empsalary = ?, empdob = ?, empemailid = ?, emppassword = ? where empid= ?";
    ...
    public void update(int empId, Employee employee) {
        ...
        jdbcTemplate.update(UPDATE_SQL, employee.getEmpName(), employee.getEmpAddress(), employee.getEmpContactNumber(), employee.getEmpSalary(), employee.getEmpDOB(), employee.getEmpEmailId(), employee.getEmpPassword(), empId);
    }
